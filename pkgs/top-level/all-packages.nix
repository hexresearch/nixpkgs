...
in
{
  ...
  bitcoin  = libsForQt5.callPackage ../applications/blockchains/bitcoin { miniupnpc = miniupnpc_2; withGui = true; };
  bitcoind = callPackage ../applications/blockchains/bitcoin { miniupnpc = miniupnpc_2; withGui = false; };
